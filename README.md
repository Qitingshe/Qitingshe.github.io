...
```
# Site settings
title: QITINGSHE                   		# 你的博客网站标题
SEOTitle: 旗亭涉的博客 | Qitingshe Blog	# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: qitingshe     # 你的github账号
...
friends: [
    {
        title: "Qitingshe Blog",
        href: "https://qitingshe.github.io/"
    },
    {
        title: "Apple",
...
# Google Analytics
ga_track_id: 'UA-00000000-1'            # 你用Google账号去注册一个就会给你一个这样的id
...
我的博客标题是 **“QITINGSHE”** 但是我想要在搜索的时候显示 **“旗亭涉的博客 | Qitingshe Blog”** ，这个就需要 SEO Title 来定义了。
